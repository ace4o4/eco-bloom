      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mt-4 mb-4">
            How <span className="text-gradient-cool">Eco-Sync</span> Works
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              ...
              >
                {/* Step Number */}
                <motion.div
                  className="absolute -top-4 -left-4 w-8 h-8 rounded-full bg-background border-2 border-primary flex items-center justify-center font-bold text-primary text-sm z-10 shadow-neon"
                ...
                {index < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-1/2 -right-4 text-primary/50 text-2xl">
                    →
                  </div>
                )}
              </motion.div>
