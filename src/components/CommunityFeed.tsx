...
const levelColors = {
  seedling: "bg-secondary/30 text-secondary",
  sapling: "bg-primary/30 text-primary",
  tree: "bg-info/30 text-info",
  oak: "bg-gradient-to-br from-primary to-secondary text-white",
};
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mt-4 mb-4">
            Every Match <span className="text-gradient-warm">Tells a Story</span>
          </h2>
          ...
          {stories.map((story, index) => (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative">
                    ...
                    {story.level === "oak" && (
                      <div className="absolute -top-1 -right-1 w-5 h-5 bg-golden rounded-full flex items-center justify-center shadow-lg">
              ...
              <p className="text-foreground/80 mb-4">
                ...
                {story.action}{" "}
                <span className="font-medium text-secondary">{story.recipient}</span>
              </p>
              ...
              <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-4 mb-4 border border-primary/20">
                <div className="flex items-center justify-center gap-2 text-primary">
                  ...
                  <span className="font-bold text-lg text-gradient-eco">{story.impact}</span>
                </div>
              </div>
        ...
        >
          <button className="story-link text-primary font-semibold hover:text-secondary transition-colors">
            View All Stories →
          </button>
        </motion.div>
      </div>
