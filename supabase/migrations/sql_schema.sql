...
-- =====================================================
-- =====================================================
-- ADDITIONAL FIELDS FOR PLANT MATCH (Jan 2026)
-- =====================================================

-- Add image and contact fields to listings table
...
-- Simple index for location queries
CREATE INDEX IF NOT EXISTS idx_listings_location_lat_lng 
ON public.listings(location_lat, location_lng) 
WHERE location_lat IS NOT NULL AND location_lng IS NOT NULL;

-- Distance search function (simplified)
...
AS $$
  ...
  WHERE location_lat IS NOT NULL 
    ...
    AND type = 'offering'
  ORDER BY 
    (point(location_lng, location_lat) <-> point(lng, lat))
  LIMIT 100;
$$;